        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
          ...
          <div className="lg:col-span-7 grid grid-cols-2 gap-10">
             <div className="reveal overflow-hidden aspect-[3/4] mt-24 bg-stone-100 border border-black/5">
                <img src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover grayscale opacity-50 hover:opacity-80 transition-all duration-[2s]" alt="Detail" />
             </div>
             <div className="reveal overflow-hidden aspect-[3/4] mb-24 bg-stone-100 border border-black/5" style={{ transitionDelay: '300ms' }}>
                <img src="https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover grayscale opacity-50 hover:opacity-80 transition-all duration-[2s]" alt="Aesthetic" />
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-60 bg-white text-dark-text overflow-hidden border-t border-black/5">
        <div className="container mx-auto px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
            {[
              { title: "The Core Legging", price: "$120", img: "https://images.unsplash.com/photo-1571945153237-4929e783ee4a?auto=format&fit=crop&q=80&w=800" },
              { title: "The Sculpt Bra", price: "$85", img: "https://images.unsplash.com/photo-1611605698335-8b1c422c1538?auto=format&fit=crop&q=80&w=800" },
              { title: "The Flow Wrapper", price: "$145", img: "https://images.unsplash.com/photo-1582233479366-6d38bc390a08?auto=format&fit=crop&q=80&w=800" }
            ].map((item, idx) => (
              <div key={idx} className="group cursor-pointer reveal" style={{ transitionDelay: `${idx * 200}ms` }}>
                <div className="aspect-[2/3] bg-stone-100 border border-black/5 overflow-hidden mb-10">
                    <img src={item.img} className="w-full h-full object-cover grayscale opacity-40 group-hover:scale-110 group-hover:opacity-80 transition-all duration-[2s]" alt={item.title} />
                </div>
                <div className="flex justify-between items-baseline">
                    <h5 className="uppercase tracking-[0.4em] text-[10px] font-bold font-sans group-hover:text-copper transition-colors">{item.title}</h5>
