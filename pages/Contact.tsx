...
const Contact: React.FC = () => {
  ...
  return (
    <div className="pt-56 md:pt-[420px] pb-32 md:pb-60 bg-white min-h-screen text-dark-text">
      <div className="max-w-screen-xl mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 md:gap-32">
          <div className="reveal">
            <h4 className="text-copper text-[9px] md:text-[10px] tracking-[0.6em] md:tracking-[0.8em] uppercase mb-12 md:mb-16 font-bold">Concierge</h4>
            ...
            <p className="text-lg md:text-2xl text-dark-secondary/50 mb-16 md:mb-32 font-light leading-relaxed max-w-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-12 md:gap-24">
              <div>
                <h5 className="text-[9px] md:text-[10px] uppercase tracking-[0.4em] md:tracking-[0.5em] font-bold mb-6 md:mb-10 text-black/20">Our Harare Studio</h5>
                <p className="text-lg md:text-xl font-light text-dark-secondary leading-relaxed">Harare, Zimbabwe</p>
              </div>

              <div>
                <h5 className="text-[9px] md:text-[10px] uppercase tracking-[0.4em] md:tracking-[0.5em] font-bold mb-6 md:mb-10 text-black/20">Inquiries</h5>
              ...
              <div>
                <h5 className="text-[9px] md:text-[10px] uppercase tracking-[0.4em] md:tracking-[0.5em] font-bold mb-6 md:mb-10 text-black/20">Hours</h5>
            ...
            <div className="bg-stone-50 p-8 md:p-20 border border-black/5 shadow-2xl backdrop-blur-sm rounded-[1px]">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-12 md:space-y-16">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-copper text-white py-6 md:py-8 text-[10px] md:text-[11px] tracking-[0.5em] md:tracking-[0.6em] uppercase font-bold hover:bg-dark-text hover:text-white transition-all shadow-lg mt-12 md:mt-16"
                  >
                    Request Access
                  </button>
